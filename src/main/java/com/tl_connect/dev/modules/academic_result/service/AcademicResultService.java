...
public class AcademicResultService {
        ...
        public List<SemesterResultDTO> getAllAcademicResult(Pageable pageable) {
                List<SubjectResultRow> subjectResultsRows = resultRepository.findSubjectResult(pageable);
                List<SemesterSummaryView> semesterSummaries = resultRepository.findSemesterSummary();
