...
public class TuitionServiceImpl implements TuitionService {
    ...
    public TuitionInvoiceView findByIdAndStudentId(Long invoiceId, Long studentId){
        return tuitionInvoiceRepository.findByIdAndStudentId(invoiceId, studentId)
                .orElseThrow(() -> new NotFoundException("Invoice not found"));
    }

    public TuitionInvoice findById(Long invoiceId) {
        return tuitionInvoiceRepository.findById(invoiceId)
                .orElseThrow(() -> new NotFoundException("Invoice not found"));
    }

    public List<TuitionInvoiceItem> findAllItemsByInvoiceId(Long invoiceId) {
        return tuitionInvoiceItemRepository.findAllByInvoiceId(invoiceId);
    }
