...
public class SemesterServiceImpl implements SemesterService {
    ...
    public List<SemesterDTO> getAllStudentSemesters(Long studentId) {
        ...
        return semesterCacheService.getSemestersByYear(yearStudy.getStartYear(), yearStudy.getEndYear());
    }
    ...
    public Long createSemester(CreateSemesterDTO dto) {
        if (semesterRepository.existsByAcademicYearsAndSemesterNumber(dto.getAcademicYears(),
                dto.getSemesterNumber())) {
            throw new InvalidInputException(
                    "Semester " + dto.getAcademicYears() + "-" + dto.getSemesterNumber() + " already exists");
        }
        ...
        Semester semester = Semester.create(dto.getSemesterName(), dto.getSemesterCode(), dto.getAcademicYears(),
                dto.getSemesterNumber(), dto.getStartDate(), dto.getEndDate());
        try {
    ...
    public void updateSemester(Long id, UpdateSemesterDTO dto) {
        ...
        semester.update(dto.getSemesterName(), dto.getSemesterCode(), dto.getAcademicYears(), dto.getSemesterNumber(),
                dto.getStartDate(), dto.getEndDate());

        if (semesterRepository.existsByAcademicYearsAndSemesterNumberAndIdNot(semester.getAcademicYears(),
                semester.getSemesterNumber(), id)) {
            throw new InvalidInputException(
                    "Semester " + semester.getAcademicYears() + "-" + semester.getSemesterNumber() + " already exists");
        }
        ...
        cacheHelper.evictAfterCommit(() -> semesterCacheService.evictAll());
    }
